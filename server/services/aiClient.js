...
// 🔁 CHANGED: model name ko constant me rakha + new name
const MODEL_NAME = "gemini-flash-latest"; // pehle "gemini-1.5-flash" tha
...
if (apiKey) {
  try {
    ...
    // 🔁 CHANGED: yaha new model name use kiya
    model = genAI.getGenerativeModel({ model: MODEL_NAME });
    console.log("✅ Gemini model initialised successfully with:", MODEL_NAME);
  } catch (err) {
